          ...
          <div className="flex flex-col items-end justify-center h-full w-full lg:w-1/2 ms:pl-10 relative z-50">
            <div className="relative lg:absolute max-w-4xl xl:max-w-6xl left-0 container lg:w-screen w-full">
              <img
                ...
                className="mt-20 lg:mt-24 xl:mt-40 w-full mb-20 lg:mb-0 lg:h-full ml-0 lg:-ml-12 h-auto"
            alt=""
            />
            </div>
          </div>
              ...
              <div className="w-full xl:w-1/2 xl:pr-8">
                ...
                <blockquote className="w-full flex flex-col-reverse md:flex-row text-center md:text-left  items-center justify-between p-6 col-span-1 bg-gray-100 rounded-lg hover:bg-white hover:shadow transition-all duration-200 ease mt-16 mb-16 xl:mb-0">
                  <div className="flex flex-col pr-10">
                    ...
                    <h3 className="pl-12 text-gray-800 text-base mt-3 leading-5 font-medium truncate">
                      Kenny Jones{" "}
                      <span className=" text-gray-500 text-sm leading-5 truncate mt-1">
                        - CEO SomeCompany
                      </span>
                    </h3>
                    <p className=" text-gray-500 text-sm leading-5 truncate mt-1" />
                  </div>
                  <img
                    className="w-24 h-24 bg-gray-300 rounded-full flex-shrink-0 object-cover mb-5 md:mb-0"
                 alt=""
